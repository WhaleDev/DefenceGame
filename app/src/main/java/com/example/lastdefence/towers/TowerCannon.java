...
/**
 * Created by whale on 2019-09-10 22:03
 */
public class TowerCannon implements Tower { //实现接口序列化箭塔对象，用于传递对象
    ...
    public TowerCannon(float x, float y, Bitmap bitmap, GameView mv) {
        super();
        this.x = x;
        this.y = y;
    ...
    @Override
    public void sell() {
        mv.coin += Constants.TOWER3CURRENTPRICE[currentState-1];
    }
