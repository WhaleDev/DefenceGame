...
/**
 * Created by whale on 2019-09-09 22:39
 */
public class BulletLaser implements Bullet {
    ...
    public BulletLaser(float x, float y, Monster a, int currentState, GameView mv){
        this.mv = mv;
        this.currentX=x;
        this.currentY=y;
        monster = a;
